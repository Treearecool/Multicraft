...
$net2ftp_messages["Processing the entries"] = "Przetwarzanie składowych listy";
...
$net2ftp_messages["Decompressing archives and transferring files"] = "Dekompresja plików i przesyłanie";
$net2ftp_messages["Searching the files..."] = "Szukanie plików...";
$net2ftp_messages["Uploading new file"] = "Przesyłanie nowego pliku";
...
// checkAuthorization()
$net2ftp_messages["The FTP server <b>%1\$s</b> is not in the list of allowed FTP servers."] = "Serwer <b>%1\$s</b> Nie znajduje się na liście dozwolonych serwerów.";
$net2ftp_messages["The FTP server <b>%1\$s</b> is in the list of banned FTP servers."] = "Serwer <b>%1\$s</b> jest na czarnej liście.";
...
$net2ftp_messages["Unable to connect to FTP server <b>%1\$s</b> on port <b>%2\$s</b>.<br /><br />Are you sure this is the address of the FTP server? This is often different from that of the HTTP (web) server. Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nie można połączyć się z serwerem FTP <b>%1\$s</b> na porcie <b>%2\$s</b>.<br /><br />Czy jesteś pewny że jest to adres serwera FTP? Często serwer FTP ma inny adres niż serwer HTTP. Skontaktuj się z dostawcą internetu bądź administratorem.<br />";
$net2ftp_messages["Unable to login to FTP server <b>%1\$s</b> with username <b>%2\$s</b>.<br /><br />Are you sure your username and password are correct? Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nie można zalogować się na serwer FTP<b>%1\$s</b> użytkownik <b>%2\$s</b>.<br /><br />czy jesteś pewien że nazwa użytkownika i hasło są poprawne? Skontaktuj się z dostawcą internetu bądź administratorem.<br />";
$net2ftp_messages["Unable to switch to the passive mode on FTP server <b>%1\$s</b>."] = "Nie można przełączyć się w tryb pasywny na serwerze FTP <b>%1\$s</b>.";

// ftp_openconnection2()
$net2ftp_messages["Unable to connect to the second (target) FTP server <b>%1\$s</b> on port <b>%2\$s</b>.<br /><br />Are you sure this is the address of the second (target) FTP server? This is often different from that of the HTTP (web) server. Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nie można połączyć się z drugim serwerem FTP <b>%1\$s</b> na porcie <b>%2\$s</b>.<br /><br />Czy jesteś pewny że jest to adres drugiego serwera FTP? Często serwer FTP ma inny adres niż serwer HTTP. Skontaktuj się z dostawcą internetu bądź administratorem.<br />";
$net2ftp_messages["Unable to login to the second (target) FTP server <b>%1\$s</b> with username <b>%2\$s</b>.<br /><br />Are you sure your username and password are correct? Please contact your ISP helpdesk or system administrator for help.<br />"] = "Nie można zalogować się na drugi serwer FTP<b>%1\$s</b> użytkownik <b>%2\$s</b>.<br /><br />czy jesteś pewien że nazwa użytkownika i hasło są poprawne? Skontaktuj się z dostawcą internetu bądź administratorem.<br />";
$net2ftp_messages["Unable to switch to the passive mode on the second (target) FTP server <b>%1\$s</b>."] = "ie można przełączyć się w tryb pasywny na drugim serwerze FTP <b>%1\$s</b>.";

// ftp_myrename()
$net2ftp_messages["Unable to rename directory or file <b>%1\$s</b> into <b>%2\$s</b>"] = "Nie można zmienić nazwy katalogu lub pliku <b>%1\$s</b> na <b>%2\$s</b>";
...
// ftp_rmdir2()
$net2ftp_messages["Unable to delete the directory <b>%1\$s</b>"] = "Nie można usunąć katalogu <b>%1\$s</b>";

// ftp_delete2()
$net2ftp_messages["Unable to delete the file <b>%1\$s</b>"] = "Nie można skasować pliku <b>%1\$s</b>";

// ftp_newdirectory()
$net2ftp_messages["Unable to create the directory <b>%1\$s</b>"] = "Nie można utworzyć katalogu <b>%1\$s</b>";

// ftp_readfile()
$net2ftp_messages["Unable to create the temporary file"] = "Nie można utworzyć pliku tymczasowego";
$net2ftp_messages["Unable to get the file <b>%1\$s</b> from the FTP server and to save it as temporary file <b>%2\$s</b>.<br />Check the permissions of the %3\$s directory.<br />"] = "Nie można pobrać pliku <b>%1\$s</b> z serwera FTP i zapisać go jako plik tymczasowy <b>%2\$s</b>.<br />Sprawdź uprawnienia dla katalogu %3\$s.<br />";
...
$net2ftp_messages["Unable to open the temporary file. Check the permissions of the %1\$s directory."] = "Nie można otworzyć pliku tymczasowego. Sprawdź uprawnienia dla katalogu %1\$s.";
$net2ftp_messages["Unable to write the string to the temporary file <b>%1\$s</b>.<br />Check the permissions of the %2\$s directory."] = "Nie można zapisać tekstu w pliku tymczasowym <b>%1\$s</b>.<br />Sprawdź uprawnienia dla katalogu %2\$s.";
$net2ftp_messages["Unable to close the handle of the temporary file"] = "Nie można zamknąć pliku tymczasowego";
$net2ftp_messages["Unable to put the file <b>%1\$s</b> on the FTP server.<br />You may not have write permissions on the directory."] = "Nie można umieścić pliku <b>%1\$s</b> na serwerze FTP.<br />Możesz nie mieć uprawnień do tego katalogu.";
$net2ftp_messages["Unable to delete the temporary file"] = "Nie można skasować pliku tymczasowego";
...
$net2ftp_messages["Unable to create the subdirectory <b>%1\$s</b>. It may already exist. Continuing the copy/move process..."] = "Nie można utworzyć podkatalogu <b>%1\$s</b>. Może już istnieć. Kontynuuję proces kopiowania/przenoszenia...";
...
$net2ftp_messages["Unable to delete the subdirectory <b>%1\$s</b> - it may not be empty"] = "Nie można usunąć podkatalogu <b>%1\$s</b> - może nie jest pusty";
$net2ftp_messages["Deleted subdirectory <b>%1\$s</b>"] = "Usunięto podkatalog <b>%1\$s</b>";
$net2ftp_messages["Deleted subdirectory <b>%1\$s</b>"] = "Usunięto podkatalog <b>%1\$s</b>";
...
$net2ftp_messages["Processing of directory <b>%1\$s</b> completed"] = "Przetwarzanie katalogu <b>%1\$s</b> zakończone";
$net2ftp_messages["The target for file <b>%1\$s</b> is the same as the source, so this file will be skipped"] = "Plik docelowy <b>%1\$s</b> jest taki sam jak plik źródłowy, więc zostanie pominięty";
...
$net2ftp_messages["Unable to copy the file <b>%1\$s</b>"] = "Nie można skopiować pliku <b>%1\$s</b>";
...
$net2ftp_messages["Moved file <b>%1\$s</b>"] = "Przesunięto plik <b>%1\$s</b>";
$net2ftp_messages["Unable to delete the file <b>%1\$s</b>"] = "Nie można skasować pliku <b>%1\$s</b>";
...
// ftp_getfile()
$net2ftp_messages["Unable to copy the remote file <b>%1\$s</b> to the local file using FTP mode <b>%2\$s</b>"] = "Nie można skopiować pliku ze zdalego systemu <b>%1\$s</b> do pliku lokalnego przy użyciu trybu FTP <b>%2\$s</b>";
$net2ftp_messages["Unable to delete file <b>%1\$s</b>"] = "Nie można skasować pliku <b>%1\$s</b>";
...
$net2ftp_messages["Unable to copy the local file to the remote file <b>%1\$s</b> using FTP mode <b>%2\$s</b>"] = "Nie można skopiować pliku lokalnego do pliku zdalnego <b>%1\$s</b> przy użyciu trybu FTP <b>%2\$s</b>";
...
// ftp_zip()
$net2ftp_messages["Unable to create the temporary file"] = "Nie można utworzyć pliku tymczasowego";
$net2ftp_messages["The zip file has been saved on the FTP server as <b>%1\$s</b>"] = "Plik zip został zapisany na serwerze FTP jako <b>%1\$s</b>";
...
$net2ftp_messages["The zip file has been sent to <b>%1\$s</b>."] = "Plik zip został wysłany do <b>%1\$s</b>.";

// acceptFiles()
$net2ftp_messages["File <b>%1\$s</b> is too big. This file will not be uploaded."] = "Plik <b>%1\$s</b> jest zbyt duży. Ten plik nie może być pobrany.";
...
$net2ftp_messages["File <b>%1\$s</b> could not be moved"] = "Plik <b>%1\$s</b> nie może być przeniesiony";
...
// ftp_transferfiles()
$net2ftp_messages["File <b>%1\$s</b> could not be transferred to the FTP server"] = "Plik <b>%1\$s</b> nie może być preniesiony na serwer FTP";
$net2ftp_messages["File <b>%1\$s</b> has been transferred to the FTP server using FTP mode <b>%2\$s</b>"] = "Plik <b>%1\$s</b> został przeniesiony na serwer FTP w trybie <b>%2\$s</b>";
$net2ftp_messages["Transferring files to the FTP server"] = "Przesyłanie plików na serwer FTP";

// ftp_unziptransferfiles()
$net2ftp_messages["Processing archive nr %1\$s: <b>%2\$s</b>"] = "Przetwarzanie archiwum nr %1\$s: <b>%2\$s</b>";
$net2ftp_messages["Archive <b>%1\$s</b> was not processed because its filename extension was not recognized. Only zip, tar, tgz and gz archives are supported at the moment."] = "Archiwum <b>%1\$s</b> nie zostało przetworzone gdyż jego rozszeżenie nie zostało rozpoznane. Obecnie tylko archiwa zip, tar, tgz i gz są obsługiwane.";
...
// ftp_mysite()
$net2ftp_messages["Unable to execute site command <b>%1\$s</b>"] = "Nie można wykonać lokalnego polecenia <b>%1\$s</b>";
...
$net2ftp_messages["Due to technical problems the email to <b>%1\$s</b> could not be sent."] = "W związku z problemami technicznymi email do <b>%1\$s</b> nie mógł być wysłany.";
...
$net2ftp_messages["Status: <b>This file could not be saved</b>"] = "Status: <b>Nie można zapisać tego pliku</b>";
...
$net2ftp_messages["The word <b>%1\$s</b> was not found in the selected directories and files."] = "Słowo <b>%1\$s</b> nie zostało znalezione w zaznaczonych katalogach i plikach.";
$net2ftp_messages["The word <b>%1\$s</b> was found in the following files:"] = "Słowo <b>%1\$s</b> znaleziono w następujących plikach:";
...
$net2ftp_messages["The new directories will be created in <b>%1\$s</b>."] = "Nowe katalogi będą utworzone w <b>%1\$s</b>.";
$net2ftp_messages["New directory name:"] = "Nazwa nowego katalogu:";
$net2ftp_messages["Directory <b>%1\$s</b> was successfully created."] = "Katalog <b>%1\$s</b> został utworzony.";
...
$net2ftp_messages["The new name may not contain any dots. This entry was not renamed to <b>%1\$s</b>"] = "Nowa nazwa nie może zawierać zadnych kropek. Ta pozycja nie została przemianowana na <b>%1\$s</b>";
...
$net2ftp_messages["<b>%1\$s</b> was successfully renamed to <b>%2\$s</b>"] = "<b>%1\$s</b> została przemianowana na <b>%2\$s</b>";
...
$net2ftp_messages["The email address you have entered (%1\$s) does not seem to be valid.<br />Please enter an address in the format <b>username@domain.com</b>"] = "Adres, który wprowadzono (%1\$s) nie jest prawidowym adresem email.<br />Wprowadź adres w formacie <b>username@domain.com</b>";
