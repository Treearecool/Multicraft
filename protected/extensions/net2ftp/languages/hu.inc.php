...
$net2ftp_messages["Logging into the FTP server"] = "Kilépés az FTP szerverből";
...
$net2ftp_messages["Logging out of the FTP server"] = "Kilépés az FTP szerverből";
$net2ftp_messages["Getting the list of directories and files"] = "Megismeri akönyvtárak  listáját és  a fájlokat";
...
$net2ftp_messages["Checking files"] = "Fájlok ellenőrzése";
...
$net2ftp_messages["Copying the net2ftp installer script to the FTP server"] = "Másolás a net2ftp telepítő script az FTP szerverre";
$net2ftp_messages["Script finished in %1\$s seconds"] = "A script fejeződött %1\$s másodpercen belül";
...
$net2ftp_messages["The directory <b>%1\$s</b> could not be selected - you may not have sufficient rights to view this directory, or it may not exist."] = "A könyvtár <b>%1\$s</b> nem lehet kiválasztani - lehet, hogy nem rendelkezik megfelelő jogokkal, hogy megtekinthesse ezt a könyvtárat, vagy nem is létezik.";
...
$net2ftp_messages["Files which are too big can't be downloaded, uploaded, copied, moved, searched, zipped, unzipped, viewed or edited; they can only be renamed, chmodded or deleted."] = "Fájlok, amelyek túl nagy, nem lehet letölteni, feltöltött, másolhatók, mozgathatók, kereshető, tömörített, cipzárat kinyitni, megtekintett vagy szerkesztett, csak akkor lehet átnevezni, chmodded vagy törölni.";
...
$net2ftp_messages["The FTP server <b>%1\$s</b> is in the list of banned FTP servers."] = "Az FTP szerver <b>%1\$s</b> van a tilalmi listán szereplő FTP-szervereket.";
...
$net2ftp_messages["Your IP address (%1\$s) is in the list of banned IP addresses."] = "Az Ön IP címe (%1\$s) van a tilalmi listán szereplő IP-címek.";

// isAuthorizedDirectory()
$net2ftp_messages["Table net2ftp_users contains duplicate rows."] = "Táblázat tartalmazza net2ftp_users ismétlődő sorokban.";
...
$net2ftp_messages["Table net2ftp_log_consumption_ipaddress contains duplicate rows."] = "Táblázat tartalmazza net2ftp_log_consumption_ipaddress ismétlődő sorokban.";
$net2ftp_messages["Table net2ftp_log_consumption_ftpserver contains duplicate rows."] = "Táblázat tartalmazza net2ftp_log_consumption_ftpserver ismétlődő sorokban.";
...
$net2ftp_messages["Table net2ftp_log_consumption_ipaddress contains duplicate entries."] = "Táblázat tartalmazza net2ftp_log_consumption_ipaddress ismétlődő bejegyzéseket.";
...
$net2ftp_messages["Table net2ftp_log_consumption_ftpserver contains duplicate entries."] = "Tképes net2ftp_log_consumption_ftpserver ismétlődő bejegyzéseket tartalmaz.";
$net2ftp_messages["Table net2ftp_log_access could not be updated."] = "Táblázat net2ftp_log_access nem lehet frissíteni.";
$net2ftp_messages["Table net2ftp_log_access contains duplicate entries."] = "Táblázat tartalmazza net2ftp_log_access ismétlődő bejegyzéseket.";


// -------------------------------------------------------------------------
// /includes/database.inc.php
// -------------------------------------------------------------------------
$net2ftp_messages["Unable to connect to the MySQL database. Please check your MySQL database settings in net2ftp's configuration file settings.inc.php."] = "Nem sikerült csatlakozni a MySQL adatbázishoz. Kérjük, ellenőrizze a MySQL adatbázis beállításait net2ftp konfigurációs fájl settings.inc.php.";
$net2ftp_messages["Unable to select the MySQL database. Please check your MySQL database settings in net2ftp's configuration file settings.inc.php."] = "Nem választhatja a MySQL adatbázisban. Kérjük, ellenőrizze a MySQL adatbázis beállításait net2ftp konfigurációs fájl settings.inc.php.";
...
$net2ftp_messages["Go to the login page"] = "Menjen a bejelentkező oldalra";
...
$net2ftp_messages["Unable to get the file <b>%1\$s</b> from the FTP server and to save it as temporary file <b>%2\$s</b>.<br />Check the permissions of the %3\$s directory.<br />"] = "Nem sikerült beolvasni a fájlt <b>%1\$s</b> Az FTP-kiszolgáló, és mentse el az ideiglenes fájlt <b>%2\$s</b>.<br />Ellenőrizze a jogosultságait a %3\$s könyvtárat.<br />";
$net2ftp_messages["Unable to open the temporary file. Check the permissions of the %1\$s directory."] = "Nem sikerült megnyitni az ideiglenes fájlt. Ellenőrizze a jogosultságait a %1\$s könyvtárat.";
...
// ftp_writefile()
$net2ftp_messages["Unable to create the temporary file. Check the permissions of the %1\$s directory."] = "Nem sikerült létrehozni az ideiglenes fájlt. Ellenőrizze a jogosultságait a%1\$s könyvtárat.";
$net2ftp_messages["Unable to open the temporary file. Check the permissions of the %1\$s directory."] = "Nem sikerült megnyitni az ideiglenes fájlt. Ellenőrizze a jogosultságait a %1\$s könyvtárat.";
$net2ftp_messages["Unable to write the string to the temporary file <b>%1\$s</b>.<br />Check the permissions of the %2\$s directory."] = "Nem lehet írni a húr az ideiglenes fájl <b>%1\$s</b>.<br />Ellenőrizze a jogosultságait a %2\$s könyvtárat.";
$net2ftp_messages["Unable to close the handle of the temporary file"] = "Nem sikerült bezárni a kilincset az ideiglenes fájl";
...
// ftp_downloadfile()
$net2ftp_messages["Unable to delete the temporary file"] = "Nem sikerült törölni az ideiglenes fájlt";
$net2ftp_messages["Unable to send the file to the browser"] = "Nem sikerült elküldeni a fájlt a böngésző";
...
$net2ftp_messages["If you know nothing about this or if you don't trust that person, please delete this email without opening the Zip file in attachment."] = "Ha nem tudsz semmit erről, vagy ha nem bízol a személy, törölje az e-mail megnyitása nélkül a zip fájlt mellékletként.";
...
$net2ftp_messages["Time of sending: "] = "Küldés időpontja: ";
...
$net2ftp_messages["You did not provide any file to upload."] = "Ön nem adott ki a feltöltendő fájlt.";
...
$net2ftp_messages["The task you wanted to perform with net2ftp took more time than the allowed %1\$s seconds, and therefor that task was stopped."] = "A feladat akartál végrehajtható net2ftp több időt, mint a megengedett %1\$s másodperc, és ennek feladata az volt, hogy megállt.";
$net2ftp_messages["This time limit guarantees the fair use of the web server for everyone."] = "Ez a határidő garantálja a tisztességes felhasználása a webszerver mindenki számára.";
...
$net2ftp_messages["If you really need net2ftp to be able to handle big tasks which take a long time, consider installing net2ftp on your own server."] = "Ha tényleg szükség van net2ftp, hogy képes legyen kezelni a nagy feladatokat, amelyek hosszú időt vesz igénybe, helyezzen üzembe net2ftp saját szerveren.";
...
$net2ftp_messages["Due to technical problems the email to <b>%1\$s</b> could not be sent."] = "Műszaki problémák miatt az e-mail <b>%1\$s</b> nem lehet elküldeni.";
...
$net2ftp_messages["You did not fill in your login information in the popup window.<br />Click on \"Go to the login page\" below."] = "Ön nem adja meg a személyes bejelentkezési adatait a felugró ablakban.<br />Kattintson \"Menjen a bejelentkező oldalra\"lent.";
...
$net2ftp_messages["Executable"] = "Kivihető";
...
$net2ftp_messages["Bookmark"] = "Könyvjelző";
...
$net2ftp_messages["Date from:"] = "Időpontot:";
...
$net2ftp_messages["The connection to the server <b>%1\$s</b> could not be set up. Please check the database settings you've entered."] = "A kapcsolat a kiszolgálóval <b>%1\$s</b> nem lehetett létrehozni. Kérjük, ellenőrizze az adatbázis beállításokat lépett.";
...
$net2ftp_messages["Send arbitrary FTP commands to the FTP server"] = "Küldjön tetszőleges FTP-parancsok az FTP-kiszolgáló";
...
$net2ftp_messages["Check if there are new or obsolete messages"] = "Ellenőrizze, hogy vannak új üzenetek vagy elavult";
...
$net2ftp_messages["The Apache functions are not available on this webserver."] = "Az Apache funkciók nem érhetők el ezen a webszerveren.";
$net2ftp_messages["The MySQL functions are not available on this webserver."] = "A MySQL függvények nem érhetők el ezen a webszerveren.";
...
$net2ftp_messages["Troubleshoot your net2ftp installation"] = "Elhárítása a telepítő net2ftp";
$net2ftp_messages["Printing the result"] = "Nyomtatás eredménye";

$net2ftp_messages["Checking if the FTP module of PHP is installed: "] = "Ellenőrzése, ha az FTP modul a PHP telepítését: ";
$net2ftp_messages["yes"] = "igen";
$net2ftp_messages["no - please install it!"] = "nem - Kérjük, telepítse azt!";

$net2ftp_messages["Checking the permissions of the directory on the web server: a small file will be written to the /temp folder and then deleted."] = "Ellenőrzi a jogosultságait a könyvtárat a webszerveren: egy kis fájlt kell írni a / temp mappát, majd el kell hagyni.";
$net2ftp_messages["Creating filename: "] = "Fájlnév létrehozása: ";
$net2ftp_messages["OK. Filename: %1\$s"] = "OK. Fájlneve: %1\$s";
$net2ftp_messages["not OK"] = "nem OK";
$net2ftp_messages["OK"] = "OK";
$net2ftp_messages["not OK. Check the permissions of the %1\$s directory"] = "nem OK. Ellenőrizze a jogosultságait a %1\$s könyvtárat";
...
$net2ftp_messages["Note: when you will use this bookmark, a popup window will ask you for your username and password."] =  "Megjegyzés:: mikor fogja használni ezt a könyvjelzőt, egy felugró ablak fogja kérni a felhasználónevét és jelszavát.";
...
// browse()
$net2ftp_messages["Directories with names containing \' cannot be displayed correctly. They can only be deleted. Please go back and select another subdirectory."] = "Könyvtárak neveit tartalmazó \' nem jeleníthető meg helyesen. Csak akkor lehet hagyni. Kérjük, lépjen vissza és válasszon másik alkönyvtár.";

$net2ftp_messages["Daily limit reached: you will not be able to transfer data"] = "Napi Elérte: nem lesz képes adatátvitelre";
$net2ftp_messages["In order to guarantee the fair use of the web server for everyone, the data transfer volume and script execution time are limited per user, and per day. Once this limit is reached, you can still browse the FTP server but not transfer data to/from it."] = "Annak érdekében, hogy biztosítsa a tisztességes felhasználása a webszerver mindenki számára, az adatátvitel volumene és szkript végrehajtási idejét korlátozzák egy felhasználó, vagy naponta. Amint elérik a limitet, akkor is böngészni az FTP szerver, de nem adja át az adatokat / tőle.";
...
$net2ftp_messages["Go to the parent directory"] = "Menj a szülő könyvtár";
$net2ftp_messages["Go"] = "Go";
...
$net2ftp_messages["Chmod the selected entries (only works on Unix/Linux/BSD servers)"] = "Chmod a kiválasztott pont (csak akkor működik, Unix / Linux / BSD szerverek)";
...
$net2ftp_messages["Click to sort by %1\$s in descending order"] = "Kattintson ide a rendezéshez %1\$s a csökkenő sorrendben";
$net2ftp_messages["Click to sort by %1\$s in ascending order"] = "Kattintson ide a rendezéshez %1\$s a növekvő sorrendben";
$net2ftp_messages["Ascending order"] = "Növekvő sorrendben";
$net2ftp_messages["Descending order"] = "Csökkenő sorrendben";
...
$net2ftp_messages["Mod Time"] = "Mód. idő";
...
$net2ftp_messages["(Note: This link may not work if you don't have your own domain name.)"] = "(Megjegyzés: Ez a kapcsolat nem működik, ha Ön nem rendelkezik saját domain név.)";
...
$net2ftp_messages["Netscape, Mozilla, Firefox: right-click on the link and choose \"Bookmark This Link...\""] = "Netscape, Mozilla, Firefox: right-click on the link and choose \"Linket adja a Könyvjelzőhöz ...\"";
...
$net2ftp_messages["Upload files"] = "Feltölt fájlokat";
$net2ftp_messages["There are 3 different ways to upload files: the standard upload form, the upload-and-unzip functionality, and the Java Applet."] = "Jelenleg 3 különböző módon lehet feltölteni fájlokat: a szabványos feltöltési űrlapon, a feltöltés-és unzip funkció, és a Java kisalkalmazással.";
...
$net2ftp_messages["Passive mode"] = "Passzív mód";
$net2ftp_messages["Initial directory"] = "Kezdő könyvtár";
$net2ftp_messages["Language"] = "Nyelv";
$net2ftp_messages["Skin"] = "Felület";
...
$net2ftp_messages["Username"] = "Felhasználónév";
$net2ftp_messages["Your session has expired; please enter your password for FTP server <b>%1\$s</b> to continue."] = "Műveleti ideje lejárt, kérjük adja meg a jelszót az FTP-kiszolgáló <b>%1\$s</b> folytatásához.";
