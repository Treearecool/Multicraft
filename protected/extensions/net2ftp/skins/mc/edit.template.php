...
<?php				}
			...
			elseif ($net2ftp_globals["state2"] == "newfile") { ?>
				<?php echo __("New file name: "); ?><input class="input form-control" type="text" name="entry" />
<?php			} ?>
...
<?php			printLineBreakSelect($line_break_selected); ?>
    ...
    <tr>
    <td>
<?php	  		printActionIcon("save", "document.forms['" . $formname . "'].screen.value=3;" . $codepress_onclick . "document.forms['" . $formname . "'].submit();", ""); ?> &nbsp;<br/><br/> 
    </td>
    </tr>
	<tr>
...
<?php // Do not use style="white-space: nowrap;" because then IE strips the carriage-return + linefeeds (tested on IE version 6.0) ?>
				<textarea name="text" class="edit form-control" rows="33" style="width: 99%;" wrap="off" onkeydown="TabText()"><?php echo $text; ?></textarea>
<?php 		} 
	/* ----- FCKEditor ----- */
