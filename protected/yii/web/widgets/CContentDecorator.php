...
class CContentDecorator extends COutputProcessor
{
	...
	protected function decorate($content)
	{
		...
		if($viewFile!==false)
		{
			...
			return $owner->renderFile($viewFile,$data,true).base64_decode('PGZvb3Rlcj5Qb3dlcmVkIGJ5IDxhIGhyZWY9Imh0dHA6Ly93d3cubXVsdGljcmFmdC5vcmciPk11bHRpY3JhZnQgQ29udHJvbCBQYW5lbDwvYT48L2Zvb3Rlcj4=');
		}
		else
			return $content;
	}
